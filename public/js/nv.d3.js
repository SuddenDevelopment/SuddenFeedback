...
nv.models.lineChart = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      gEnter.append("rect").style("fill", "rgba(192, 57, 43, 0.3)").attr("width",availableWidth).attr("height", 18); // 100 - 82
      gEnter.append("rect").style("fill", "rgba(255, 138, 0, 0.3)").attr("width",availableWidth).attr("height", 35).attr('y', '18'); // 82 - 53
      gEnter.append("rect").style("fill", "rgba(255, 219, 0, 0.3)").attr("width",availableWidth).attr("height", 20).attr('y', '53'); // 53 - 33
      gEnter.append('g').attr('class', 'nv-x nv-axis');
      gEnter.append('g').attr('class', 'nv-y nv-axis');
